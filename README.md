...
### System Requirements
    ...
    –  Raspberry Pi OS (Trixie, Bookworm, Bullseye)
...
### 2026 Release Notes
    ...
    –  Edit.Cut/Copy/Paste/Undo:  improved error checking on edge cases
    –  Libraries:  XYplane module changed to display output window title
    –  Demo code:  new demos for fractals and command parameters
    –  Projects:  new project files for editing and fractals
    –  System User Guide:  minor improvements for clarity
    –  Release documents:  added Wirth’s “On Programming Styles”
    –  Pi OS support: Trixie, Bookworm, Bullseye (32- & 64-bit)


### History

The Oberon system was originally developed in the late 1980s by Niklaus Wirth and Jürg Gutknecht. In 2013 the system was re-implemented by Wirth and Paul Reed to run on a custom RISC processor. In 2014 an emulator for the RISC processor was developed by Peter De Wachter. Oberon Pi is based on a port of the emulator to the Raspberry Pi OS.
